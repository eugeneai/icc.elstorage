...
ext_modules=[
#    Extension("icc.elstorage.cython_module",
#              sources=["src/./icc.elstorage/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='icc.elstorage',
    version=version,
    description="Elastic search as metadata storage in a cellulla digital archive",
    ...
    #     """.split('\n') if c.strip()],
    # ],
    keywords='elasticsearch storage zope',
    author='Evgeny Cherkashin',
    author_email='eugeneai@irnok.net',
    url='https://github.com/eugeneai/icc.elstorage',
    license='GPL-2.0',
    ...
    entry_points={
        'console_scripts':
            ['icc.elstorage=icc.elstorage:main']
    },
